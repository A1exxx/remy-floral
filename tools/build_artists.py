...
#
# Заменено после правки заказчика: прежние 20752500 / 26524772 / 8180738
# читались как корпоративные хедшоты — человек стоит прямо, руки скрещены,
# ровный студийный свет. Нужна энергия сцены и кино, а не резюме.
CARDS = [
    ("sax", "ART-9002789.jpg", 0.30),      # саксофон в тёплом сценическом свете
    ("actor", "ART-21775096.jpg", 0.18),   # мягкий полусвет, половина лица в тени
    ("host", "ART-6570059.jpg", 0.16),     # резкий направленный свет, силуэт в тени
    ("music", "ART-9002857.jpg", 0.34),    # золотая медь инструмента, боке
]
